...
function OnThisDay() {
	...
	const handleSelectedClick = () => {
		...
		let selectedContainerBtn =
			document.getElementById("day-selected-btn");
		if (selectedContainer.style.display == "none") {
			...
			selectedContainerBtn.style.backgroundColor =
				"hsl(140, 80%, 80%)";
	...
	const handleHolidaysClick = () => {
		...
		let selectedContainerBtn =
			document.getElementById("day-holidays-btn");
		if (selectedContainer.style.display == "none") {
			selectedContainer.style.display = "block";
			selectedContainerBtn.style.backgroundColor = "hsl(70, 50%, 10%)";
			selectedContainerBtn.style.color = "hsl(140, 80%, 80%)";
		...
		if (history.selected != undefined) {
			setRender(
				<div id='on-this-day-container'>
					<h2>On This Day...</h2>
					<div id='on-this-day-inner-container'>
